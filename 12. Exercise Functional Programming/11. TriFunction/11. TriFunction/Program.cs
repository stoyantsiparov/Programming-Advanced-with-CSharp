// Събирам елементите(char of string) от функцията и проверявам дали са равни или по-голями от сумата(sum) дадена от конзолота {string(ch) >= int(sum)}
Func<string, int, bool> checkEqualOrLargerSumName =
